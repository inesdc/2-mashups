...
$uri="https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=".$apikey."&tags=".$tag."&location=".$location."&radius=".$radius."&extras=url_m,tags&format=json&nojsoncallback=1&per_page=5";
